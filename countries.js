export default [
    ...
    KAZAKHSTAN, KZ
    KENYA, KE
    KIRIBATI, KI "KOREA, DEMOCRATIC PEOPLE'S REPUBLIC OF", KP "KOREA, REPUBLIC OF", KR
    KUWAIT, KW
    KYRGYZSTAN, KG
    ...
    RWANDA, RW
    SAINT BARTHń_LEM, BL "SAINT HELENA, ASCENSION AND TRISTAN DA CUNHA", SH
    ...
    URUGUAY, UY
    UZBEKISTAN, UZ
    VANUATU, VU "VENEZUELA, BOLIVARIAN REPUBLIC OF", VE
